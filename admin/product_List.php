        ...
        <main>
            <div class="container-fluid px-4 mt-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <a href="product_Add.php" class="btn btn-success mb-3"><i class='bx bxs-plus-circle'></i>
                            เพิ่มสินค้า</a>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-primary" href="product_editPrice.php?id=<?= $row['p_id'] ?>"><i
...
?>
    <script>
        Swal.fire({
            ...
            footer: '<span style="color: #00c300;">เพิ่มสินค้าเข้าสต็อกเรียบร้อยแล้ว</span>',
            showConfirmButton: false,
            timer: 1500
        });
    </script>
